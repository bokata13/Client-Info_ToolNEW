...
namespace Client_Info_Tool
{
    public partial class HW : UserControl
    {
        ...
        private void HW_Load(object sender, EventArgs e)
        {
            ...
            mlv_disks.BeginUpdate();
            mlv_disks.Items.Clear();
            mlv_disks.View = View.Details;
            mlv_disks.View = View.Details;
            GetDisks();
            mlv_disks.AutoResizeColumns(ColumnHeaderAutoResizeStyle.ColumnContent);
            mlv_disks.AutoResizeColumns(ColumnHeaderAutoResizeStyle.HeaderSize);
            mlv_disks.EndUpdate();
            mlv_disks.AllowSorting = true;
